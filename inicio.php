...
?>
    ...
    <head>
        ...
        <link href="https://fonts.googleapis.com/css2?family=Open+Sans:wght@300;400;500;600;700;800&family=Poppins:wght@300;400;500;600;700;800&family=Jost:wght@300;400;500;600;700;800&display=swap" rel="stylesheet">
    ...
    <body>
        ...
        <header class="topbar">
            ...
            <button class="hamburger-toggle" id="hamburgerToggle" aria-label="Abrir menu" aria-expanded="false">
        ...
        <i class="bi bi-list"></i>
            ...
            <div class="topbar-nav" id="topbarNav">
                ...
                <div class="topbar-actions">
                    ...
                    <a href="cadastro-evento.html" class="btn-cadastrar">
                    ...
                    <nav class="menu-links">
                        ...
                        <a href="favoritos.html" class="link-favoritos">

                            <i class="bi bi-heart heart-outline"></i>

                            <i class="bi bi-heart-fill heart-filled"></i> Favoritos
        ...
        ">
            ...
            ?>
                            ...
                            <div class="card-evento">
                                ...
                                <a href="detalhesEvento.php?id=<?= (int)$evento['id_evento'] ?>">
                                    ...
                                    <img src="<?= htmlspecialchars($imagem) ?>" alt="<?= htmlspecialchars($evento['nome_evento']) ?>">
                ...
                ">
                    ...
                    /*
                     * Define se é gratuito.
                     */

                    $gratuito =
                        (bool) $evento['gratuidade'];


                    /*
                     * Define a imagem.
                     *
                     * Se o banco não tiver imagem,
                    ...
                    ?>
                        ...
                        <div class="card-evento">
                            ...
                            <a href="detalhesEvento.php?id=<?= (int) $evento['id_evento'] ?>">
                                ...
                                <img src="<?= e($imagem) ?>" alt="<?= e($evento['nome_evento']) ?>">
